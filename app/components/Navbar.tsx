  ...
  return (
    ...
    >
      <LinkImg
        ...
        src='/favicon.ico'
        alt='Logo'
        className='w-[30px] h-[30px] sm:w-[70px] sm:h-[70px] rounded-full shadow-glow ml-2'
      />
      <div className='flex gap-10 cursor-pointer text-white items-center'>
        <LinkText
          href='/George_Tsimis_Resume.pdf'
          text='RESUME'
          className='font-semibold text-[10px] md:text-xl font-white tracking-[2px]  hover:text-amber-300'
          target='_blank'
        />
        <LinkImg
