    ...
    pics: [
      {
        ...
        alt: 'Dashboard',
        description: 'The Borrower Portal Dashboard tab, where borrowers can view the relevant information pertaining to their loan',
      },
      {
        id: 1,
        path:'/acPics/account-profile.png',
        alt: 'Account Profile',
        description: 'The Account Profile tab, where borrowers can confirm their information is correct and make updates. Before navigating away, the borrower will be asked if they want keep unsaved changes',
      },
      {
        id: 2,
        path:'/acPics/one-time-payment.png',
        alt: 'One time payment',
        description: 'The Payments tab, where borrowers can schedule one-time payments, assuming they have linked a bank account, manually or through plaid, on the portal',
      },
      {
        id: 3,
        path:'/acPics/payment-confirmation-modal.png',
        alt: 'Payment confirmation modal',
        description: 'The Payment Confirmation Modal, where borrowers can confirm all the information is correct before initiating a payment',
      },
      {
        id: 4,
        path:'/acPics/payment-history.png',
        alt: 'Payment history',
        description: 'The Payment History tab, where borrowers can see all their payments in one place, with relevant information for each payment, and there is a sorting feature as well',
      },
      {
        id: 5,
        path:'/acPics/add-bank-account.png',
        alt: 'Add bank account',
        description: 'Adding a bank account to the portal, borrowers can link accounts manually through micro-deposits, this option takes a few business days. Or they can go through the plaid flow to link their account faster',
      },
      {
        id: 6,
      ...
      },
      {
        ...
        alt: 'Autopay Modal',
        description: 'The Autopay form modal, where borrowers can set up autopay for any day of the month. Only certain loans are eligible for Autopay, only these loans will have access to the form. Also, if the last day of the month ends before their chosen day to pay, the payment will be initiated on the last day of the month',
      }
    ]
  },
  {
